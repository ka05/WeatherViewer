...
import com.example.clay.weatherviewer.ReadForecastTask.ForecastListener;
...
public class WeatherProvider extends AppWidgetProvider 
{
   ...
   private String getZipcode(Context context)
   {
      ...
      SharedPreferences preferredCitySharedPreferences = 
         ...
         WeatherViewer.SHARED_PREFERENCES_NAME, 
      ...
      String zipcodeString = preferredCitySharedPreferences.getString(
         WeatherViewer.PREFERRED_CITY_ZIPCODE_KEY, 
   ...
   public void onReceive(Context context, Intent intent)
   {
      ...
      if (intent.getAction().equals(
         WeatherViewer.WIDGET_UPDATE_BROADCAST_ACTION))
      {
      ...
      ForecastListener
   {
         ...
         String humidity, String precipitation)
      {
         ...
         // create PendingIntent to launch WeatherViewer
         Intent intent = new Intent(context, WeatherViewer.class);
