...
import com.example.clay.weatherviewer.AddCityDialogFragment.DialogFinishedListener;
import com.example.clay.weatherviewer.CitiesFragment.CitiesListChangeListener;
import com.example.clay.weatherviewer.ReadLocationTask.LocationLoadedListener;

public class WeatherViewer extends ActionBarActivity implements
        DialogFinishedListener
{
    public static final String WIDGET_UPDATE_BROADCAST_ACTION =
            "com.french.bryan.weatherviewer.UPDATE_WIDGET";

    private static final int BROADCAST_DELAY = 10000;

    private static final int CURRENT_CONDITIONS_TAB = 0;
    private static final int FIVE_DAY_FORECAST = 1;
    ...
    private TextView currentForecastTab;
    private TextView fiveDayForecastTab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentTab = CURRENT_CONDITIONS_TAB; //load current conditions by default

        currentForecastTab = (TextView)findViewById(R.id.currentForecast);
        currentForecastTab.setBackgroundResource(R.drawable.tab_underline);
        currentForecastTab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                currentForecastTab.setBackgroundResource(R.drawable.tab_underline);
                fiveDayForecastTab.setBackgroundResource(R.drawable.tab_nounderline);
                currentTab = CURRENT_CONDITIONS_TAB;
                loadSelectedForecast();
            }
        });
        fiveDayForecastTab = (TextView)findViewById(R.id.fiveDayForecast);
        fiveDayForecastTab.setBackgroundResource(R.drawable.tab_nounderline);
        fiveDayForecastTab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                fiveDayForecastTab.setBackgroundResource(R.drawable.tab_underline);
                currentForecastTab.setBackgroundResource(R.drawable.tab_nounderline);
                currentTab = FIVE_DAY_FORECAST;
                loadSelectedForecast();
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_weather_viewer, menu);
        return true;
    }
                                        ...
                                        boolean preferred)
    {
        ...
        if (favoriteCitiesMap.containsValue(zipcodeString))
        {
            ...
            Toast errorToast = Toast.makeText(WeatherViewer.this,
                    WeatherViewer.this.getResources().getString(
            ...
            LocationLoadedListener
    {
                                     ...
                                     String countryString)
        {
            ...
            else
            {
                ...
                // not be found
                Toast zipcodeToast = Toast.makeText(WeatherViewer.this,
                        WeatherViewer.this.getResources().getString(
